      ...
      <div className="p-3.5 bg-slate-950/90 border-b border-slate-800 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center space-x-2 flex-shrink-0">
          ...
          <button
            ...
            className="px-2 py-1 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 text-[11px] font-semibold border border-slate-700 transition focus-visible:ring-2 focus-visible:ring-blue-500"
            title="Toggle Text Size"
            aria-label={`Switch to ${fontSize === 'normal' ? 'larger' : 'normal'} text size`}
          >
            {fontSize === 'normal' ? 'A+' : 'A-'}
          </button>
          ...
          <button
            onClick={handleCopy}
            className="px-2.5 py-1 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 text-[11px] font-semibold flex items-center space-x-1 border border-slate-700 transition focus-visible:ring-2 focus-visible:ring-blue-500"
              ...
              {matchingClause && (
                <div className="flex items-center justify-between mb-2 pb-1.5 border-b border-slate-800/60">
                  ...
                  <button
                    ...
                    className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase border transition flex items-center space-x-1 focus-visible:ring-2 focus-visible:ring-blue-500 ${
                      matchingClause.riskLevel === 'high'
                    ...
                    aria-label={`View ${matchingClause.title} in risk matrix`}
                  >
